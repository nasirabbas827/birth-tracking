<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="home.php">Birth Tracking</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["id"]) && !empty($_SESSION["id"])) {
                ...
                echo '<li class="nav-item"><a class="nav-link" href="view_birthrecord.php">Birth Record</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="view_death_records.php">Death Record</a></li>';
