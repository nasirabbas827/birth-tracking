...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO BirthRecords (ChildName, FatherName, MotherName, BirthDate, Gender, MotherNIC, FatherNIC, PaymentMethod, DistrictID, TehsilID, UnionCouncilID, UserID) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "ssssssssiiii", $child_name, $father_name, $mother_name, $birth_date, $gender, $mother_nic, $father_nic, $payment_method, $district_id, $tehsil_id, $union_council_id, $user_id);
